...
public class Board
{
    ...
    private void setBoard()
    {
        ...
        // SET BOARD
        // white
        board[0][1].setPiece(new Pawn(true));
        board[1][1].setPiece(new Pawn(true));
        board[2][1].setPiece(new Pawn(true));
        board[3][1].setPiece(new Pawn(true));
        board[4][1].setPiece(new Pawn(true));
        board[5][1].setPiece(new Pawn(true));
        board[6][1].setPiece(new Pawn(true));
        board[7][1].setPiece(new Pawn(true));
